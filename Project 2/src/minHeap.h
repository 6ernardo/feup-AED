...
public:
    ...
    /**
    * @brief Default constructor for a MinHeap object
    * @param n is the max number of pairs
    * @param notFound is returned when empty
    */
    MinHeap(int n, const K& notFound);

    /**
    * @brief Returns the number of elements in a heap
    * @return int
    */
    int getSize();

    /**
    * @brief Returns whether the Heap as the inserted key
    * @param key looked for
    * @return bool
    */
    bool hasKey(const K& key);

    /**
    * @brief Insert (K,V) pair in the MinHeap
    * @param key inserted
    ...
    */
    ...
    /**
    * @brief Decreases the value of a key
    * @param key to be decreased
    * @param value to be decreased
    */
    void decreaseKey(const K& key, const V& value);

    /**
    * @brief Removes and returns the key with the smaller value
    * @return K
    */
